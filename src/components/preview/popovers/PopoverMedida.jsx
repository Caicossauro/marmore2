...
export function PopoverMedida({ valorInicial, label, onConfirmar, onCancelar }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xs text-slate-500 mb-2">Tamanho da linha em metros</p>
        <input
          ref={inputRef}
          type="number"
          step="0.01"
        ...
        <div className="flex justify-end gap-2 mt-3">
          ...
          <Button variant="primary" size="sm" onClick={() => onConfirmar(valor)}>Aplicar</Button>
        </div>
      </div>
    </div>
  );
